...
@Component({
    selector: 'pristine-map',
    templateUrl: 'pristine.html',
    styleUrls: ['./../maps.css']
})

export class PristineComponent implements OnInit, AfterViewInit {
    ...
    renderOpenLayers(): void {
        ...
        var deedOverlayStyleFunction = function (feature, resolution) {
            return [
                new ol.style.Style({
                    image: new ol.style.RegularShape({
                        points: 4,
        ...
        this.Jan18IsoRaster = new ol.layer.Tile({
            source: new ol.source.XYZ({
                url: "./../../assets/pristine/iso/{z}/{x}/{y}.png",
                tileGrid: mapTileGrid,
            }),
        ...
        this.Jan18TopoRaster = new ol.layer.Tile({
            source: new ol.source.XYZ({
                url: "./../../assets/pristine/topo/{z}/{x}/{y}.png",
                tileGrid: mapTileGrid,
            }),
        ...
        this.Jan18TerrainRaster = new ol.layer.Tile({
            source: new ol.source.XYZ({
                url: "./../../assets/pristine/terra/{z}/{x}/{y}.png",
                tileGrid: mapTileGrid,
            }),
        ...
        this.Jan18RouteRaster = new ol.layer.Tile({
            source: new ol.source.XYZ({
                url: "./../../assets/pristine/routes/{z}/{x}/{y}.png",
                tileGrid: mapTileGrid,
            }),
